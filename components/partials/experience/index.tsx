		...
		<div className={`relative ${isDarkMode ? `bg-[#424543]` : `bg-[#f7f7f5]`}`}>
			...
			<FadeWhenVisible>
				<div className={`flex flex-col justify-center w-full space-y-16 relative py-16`} ref={ref}>
					<div className={`${isDarkMode ? `text-[#dce3de]` : `text-paletteText-primary`} font-bold text-center text-3xl`}>Experience</div>
					<div className={`flex flex-col w-1/2 mx-auto justify-center ${isDarkMode ? `text-[#dce3de]` : `text-paletteText-primary`}`}>
						{
							_.map(
