export const projectsConstant = [
  ...
  },
  {
    ...
    title: 'Ol Shoes',
    description:
      'A modern and large shoes store stocking a wide range of locally made shoes and bags for both men and women',
    responsibilities: [
  ...
  },
  {
    ...
    title: 'Invinitee',
    description:
      'Build dynamic web for wedding invitation involve landing page and selling generator for creating and sharing invitation to guests',
    responsibilities: [
  ...
  },
  {
    ...
    title: 'E-Basa',
    description:
      'Create web for management garbage disposal which user can swap poin after throw waste regularly with a item',
    responsibilities: [
      'Slicing page and implement API for all requirement at user and admin side',
  ...
  },
  {
    ...
    title: 'PadiUMKM',
    description:
      'Create E-Commerce platform for buying and selling procurement products and service',
    responsibilities: [
  ...
  },
  {
    ...
    title: 'BPLDH',
    description:
      "An application management of environmental funds for supporting vision preserving indonesia's environment",
    responsibilities: [
  ...
  },
  {
    ...
    description:
      'An application provided by pagii for ordering or shopping like food, drink, item, etc from merchant to customer',
    responsibilities: [
