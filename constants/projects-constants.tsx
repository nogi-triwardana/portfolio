export const projectsConstant = [
  {
    ...
    description: 'Creating generator website for printing several type of letter or type of data at cooperative',
    responsibilities: [
  ...
  },
  {
    key: 3,
    title: 'Invinitee',
    description: 'Build dynamic web for wedding invitation involve landing page and selling generator for creating and sharing invitation to guests',
    responsibilities: [
  ...
  },
  {
    key: 7,
    title: 'PadiUMKM',
    description: 'Create E-Commerce platform for buying and selling procurement products and service',
    responsibilities: [
